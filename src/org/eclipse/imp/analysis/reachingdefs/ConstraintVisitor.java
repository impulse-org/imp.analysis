...
public class ConstraintVisitor extends ASTVisitor {
    private final ConstraintCreatorBase fCreator;

    private final Set<IConstraint> fConstraints;

    public ConstraintVisitor(ConstraintCreatorBase creator) {
	Assert.isNotNull(creator);
	fCreator= creator;
	fConstraints= new LinkedHashSet<IConstraint>();
    }

    private void add(IConstraint[] constraints) {
	...
	return (IConstraint[]) fConstraints.toArray(new IConstraint[fConstraints.size()]);
    }
