...
public abstract class TType {
    ...
    /**
     * Returns <code>true</code> if the given type represents the null type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents the void type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a primitive type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents an array type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a hierarchy type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    public final boolean isHierarchyType() {
        ...
        return elementType == RAW_TYPE || elementType == PARAMETERIZED_TYPE || elementType == GENERIC_TYPE || elementType == STANDARD_TYPE;
    }

    /**
     * Returns <code>true</code> if the given type represents a standard type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a raw type. Otherwise <code>false</code> is returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a parameterized type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a generic type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a type variable. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a capture type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a wildcard type. Otherwise <code>false</code> is
     * returned.
     * 
    ...
    public final boolean isWildcardType() {
        int elementType= getKind();
        return elementType == EXTENDS_WILDCARD_TYPE || elementType == UNBOUND_WILDCARD_TYPE || elementType == SUPER_WILDCARD_TYPE;
    }

    /**
     * Returns <code>true</code> if the given type represents a unbound wildcard type. Otherwise <code>false</code>
     * is returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents an extends wildcard type. Otherwise <code>false</code>
     * is returned.
     * 
    ...
    /**
     * Returns <code>true</code> if the given type represents a super wildcard type. Otherwise <code>false</code> is
     * returned.
     * 
     ...
     * 
     * @param type
     *            The right hand side of the equals operation. The dynamic type of the actual argument must be the same
     ...
     *             if this type's TypeEnvironment was not created with rememberSubtypes == true
     */
    ...
    /**
     * Answer <code>true</code> if the receiver of this method can be assigned to the argument lhs (e.g lhs= this is a
     * valid assignment).
     * 
     * @param lhs
    ...
    /**
     * Returns whether the receiver type is type equivalent to the other type. This method considers the erasure for
     * generic, raw and parameterized types.
     * 
    ...
    /**
     * Checks whether the <code>this</code> left hand side type interpreted as a type argument of a parameterized type
     * is compatible with the given type <code>rhs</code>. For example if
    ...
    /**
     * Computes a plain pretty signature. For type with bounds (e.g type variables and wildcards) the plain signature is
     * different than the full pretty signture.
     * 
