...
public final class ArrayType extends TType {
    ...
    /**
     * Returns the component type of this array. If getDimensions() is 1, the component type is the element type. If
     * getDimensions() is > 1, the component type is an array type with element type getElementType() and dimensions
     * getDimensions() - 1.
     * 
